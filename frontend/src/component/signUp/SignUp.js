    ...
    <Container maxWidth="xs">
      ...
      >
        ...
        >
          ...
          <title>welcome</title>
          <rect x="69" width="731" height="731" fill="#57b846" opacity="0.2" />
          <rect
            x="179"
            y="68.25"
            width="510"
          ...
          />
          <rect x="604" y="113" width="255" height="506" fill="#57b846" />
          <rect
            x="175"
            y="197.5"
            width="255"
          ...
          />
          <rect x="137" y="649" width="594" height="30" fill="#57b846" />
          <rect
            x="134"
            y="50"
            width="602"
          ...
          />
          <rect x="137" y="53" width="594" height="30" fill="#57b846" />
          <rect
            x="289"
            y="113"
            width="292"
        ...
        <Typography variant="h3">TeleHealth</Typography>
        ...
        <Button
          ...
          size="small"
          disableElevation
          style={{ height: "50px", background: "#57b846", color: "#ffffff" }}
          onClick={signup}
        >
          SignUp
        </Button>
